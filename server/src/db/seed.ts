...
function seed() {
  ...
  db.insert(routeStops)
    .values([
      ...
      },
      {
        ...
        stopName: 'General Hospital',
        order: 3,
      },
      {
        routeId: 'route-10',
        stopId: 'stop-harbor',
        stopName: 'Harbor Terminal',
        order: 4,
      },
      {
        routeId: 'route-18',
  ...
  console.log(
    '✓ Seeded transport.db with stops, routes, route_stops, and arrivals',
  );
}
