...
const stops: Stop[] = [
  { id: 'stop-central', name: 'Central Station', code: '1001', area: 'Downtown', lines: ['10', '18', '42'], isFavorite: true },
  { id: 'stop-market', name: 'Market Street', code: '1002', area: 'Downtown', lines: ['10', '27'], isFavorite: true },
  { id: 'stop-riverside', name: 'Riverside Park', code: '1003', area: 'North Bank', lines: ['18', '33'], isFavorite: false },
  { id: 'stop-campus', name: 'City Campus', code: '1004', area: 'University District', lines: ['18', '42'], isFavorite: false },
  { id: 'stop-hospital', name: 'General Hospital', code: '1005', area: 'West End', lines: ['27', '33'], isFavorite: false },
  { id: 'stop-harbor', name: 'Harbor Terminal', code: '1006', area: 'Waterfront', lines: ['10', '42'], isFavorite: false },
];
...
export function getStopArrivals(stopId: string): Arrival[] {
  return snapshot.arrivals
    ...
    .sort((left, right) => new Date(left.expectedAt).getTime() - new Date(right.expectedAt).getTime());
}
